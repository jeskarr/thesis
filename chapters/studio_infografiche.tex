...
%\begin{table}[H]
%    \centering
%    \begin{tabular}{|>{\centering\arraybackslash} m{0.15\textwidth}| >{\centering\arraybackslash} m{0.25\textwidth}| >{\centering\arraybackslash} m{0.15\textwidth}| >{\centering\arraybackslash} m{0.25\textwidth}|}
%        \hline
%        Backbone Shape & Pattern & Backbone Shape & Pattern \\
%        \hline
%        \icon{infografiche/clock_vif.png} & Clock & \icon{infografiche/downladder_vif.png} & Down-ladder\\ 
%        \icon{infografiche/dome_vif.png} & Dome & \icon{infografiche/upladder_vif.png} & Up-ladder\\ 
%        \icon{infografiche/bowl_vif.png} & Bowl & \icon{infografiche/landscape_vif.png} & Landscape\\ 
%        \icon{infografiche/leftwing_vif.png} & Left-wing & \icon{infografiche/portrait_vif.png} & Portrait\\ 
%        \icon{infografiche/rightwing_vif.png} & Right-wing & \icon{infografiche/pulse_vif.png} & Pulse\\ 
%        \icon{infografiche/star_vif.png} & Star & \icon{infografiche/spiral_vif.png} & Spiral\\ 
%        \hline
%    \end{tabular}
%    \vspace{0.2cm}
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.8\columnwidth]{infografiche/pattern_vif.png} 
    \caption{Backbone shape dei pattern di Visual Information Flow (VIF)}
