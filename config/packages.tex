...
\usepackage{xltabular}                  % tabelle su più pagine
\usepackage{ltxtable}                   % tabelle su più pagine e adattabili in larghezza
\usepackage{colortbl}                   % colori per tabelle
\usepackage{enumitem}                   % itemize dentro tabelle

\usepackage{listings}                   % code

\usepackage{tablefootnote}

\usepackage{float}                      % H per immagini e tabelle
